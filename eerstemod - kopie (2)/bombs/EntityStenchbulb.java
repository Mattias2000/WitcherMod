...
public class EntityStenchbulb extends EntityThrowable{

	public static final PropertyBool EXPLODE = PropertyBool.create("explode");
	PotionEffect effect = new PotionEffect(MobEffects.WEAKNESS, 2400, 0, false, true);
	public EntityStenchbulb(World worldIn) {
		super(worldIn);
	}
	 public EntityStenchbulb(World worldIn, EntityLivingBase throwerIn)
	    {
	 ...
	 public EntityStenchbulb(World worldIn, double x, double y, double z)
	    {
	        super(worldIn, x, y, z);
	    }
