...
public class EntityDevilsPuffball extends EntityThrowable{

	public static final PropertyBool EXPLODE = PropertyBool.create("explode");
	PotionEffect effect = new PotionEffect(MobEffects.POISON, 2400, 0, false, true);
	public EntityDevilsPuffball(World worldIn) {
		super(worldIn);
	}
	 public EntityDevilsPuffball(World worldIn, EntityLivingBase throwerIn)
	    {
	 ...
	 public EntityDevilsPuffball(World worldIn, double x, double y, double z)
	    {
	        super(worldIn, x, y, z);
	    }
